...
from modules import aws_service, azure_service, gcp_service
...
class ArtSimulationController(SimulationController):
    ...
    def simulate(self, target, technique) -> None:
        ...
        elif self.config["general"]["cloud_provider"] == "gcp":
        ...
        if "win" in target:
            runner = ansible_runner.run(
                ...
                playbook=os.path.join(
                    os.path.dirname(__file__), "ansible/atomic_red_team.yml"
                ),
                extravars={
